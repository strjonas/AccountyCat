...
extension Notification.Name {
    ...
    /// Posted to open the accountability-partner creator inline in the panel.
    /// `object` is an optional `ACCharacter` to edit (nil = create a new one).
    static let acOpenPartnerCreator = Notification.Name("acOpenPartnerCreator")
}
